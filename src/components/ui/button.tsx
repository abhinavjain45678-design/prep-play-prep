  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white font-semibold hover:scale-105 shadow-medium hover:shadow-strong",
        emergency: "gradient-emergency text-emergency-foreground font-semibold animate-pulse-glow hover:scale-105 shadow-emergency",
        disaster: "bg-primary text-primary-foreground hover:bg-primary-dark transform hover:scale-105 shadow-soft hover:shadow-medium",
